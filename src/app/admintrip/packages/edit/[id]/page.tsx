      ...
      <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div key={index} className="p-4 border rounded-lg relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      value={formatCurrency(option.originalPrice || 0)}
                      onChange={(e) => {
                        const newOptions = [...priceOptions]
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      value={formatCurrency(option.cashback || 0)}
                      onChange={(e) => {
                        const newOptions = [...priceOptions]
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-bold">Status Paket</h3>
              <p className="text-sm text-gray-500 mt-1">
                {formData.isActive 
                  ? 'Paket ini aktif dan dapat dilihat oleh pengguna' 
                  : 'Paket ini tidak aktif dan tidak akan ditampilkan'}
              </p>
            </div>
